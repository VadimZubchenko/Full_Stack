...
//alustetaan express
const app = express();
// turvallisuuden vuouksi käytetään porti asenettu 'env'-ssa(terminal: 'env')  , jos ei sitten default 3000
...
//Create a new middleware function to serve files from within a given root directory (esim: 'public'). 
